...
function openModal(id) {
    ...
    if (id.startsWith('w')) {
        ...
        document.getElementById('design-info').innerHTML = `
            <img id="design-img" src="${data.img}">
            <div class="design-close-area">
                <button class="design-close-btn" onclick="closeModal('modal')">CLOSE</button>
            </div>
        `;
